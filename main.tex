...
\begin{document}
    ...
    \begin{theorem}[Properties of Pullback]\label{thm:pullback-properties}
        Let \(f \in C^\infty\), \(\omega \in \Lambda^k(\mathbb{R}^m)\). Then 
        \[
        \begin{aligned}
    ...
    \begin{definition}[Differential Form on a Manifold]\label{def:manifold-form}
        ...
        \(\omega \in \Lambda^k(\manifold[M])\), consists of a family of 
    ...
    \begin{definition}[Addition]\label{def:mani-form-add}
        Given two forms \(\omega, \eta \in \Lambda^k(\manifold[M])\), 
    ...
    \begin{definition}[Exterior Differentiation]\label{def:mani-form-diff}
        Given a form \(\omega \in \Lambda^k(\manifold[M])\), 
    ...
    \begin{definition}[Pullback]\label{def:mani-form-pullback}
        Given a form \(\omega \in \Lambda^k(\manifold[N])\) and a function 
    ...
    \end{definition}
    \begin{theorem}[Local Representation of Pullback]\label{thm:pullback-coordinate}
        Let a form \(\omega \in \Lambda^k(\manifold[N])\) and a function 
        \(f : \manifold[M] \to \manifold[N]\), \(m=\dim \manifold[M], 
        n=\dim \manifold[N]\). Consider coordinate functions 
        \(\phi : U \to \phi(U)\) on \(\manifold[M]\), and 
        \(\psi : V \to \psi(V)\) on \(\manifold[N]\).
    \end{theorem}
    \newpage
