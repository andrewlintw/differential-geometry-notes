...
headsep=0.8cm}
\usepackage{setspace}
\setlength{\parskip}{1.3ex plus 0.2ex minus 0.2ex} % space between paragraphs
...
{
    coltitle=cyan!90!black,
    colback=cyan!10!white,        % Background color for both title and content
    colbacktitle=cyan!10!white,   % Same background for title area
    colframe=cyan!90!black,      % Left border color
    fonttitle=\bfseries,         % Bold font for the title
    fontupper={\linespread{1.2}\selectfont},
    boxrule=0pt,                 % No border by default
    leftrule=4pt,                % Thick left border only
    arc=0pt,                     % Sharp corners
    left=8pt,                   % Left inner margin (more space due to thick border)
    right=8pt,                   % Right inner margin
    top=8pt,                     % Top inner margin
    bottom=8pt,                  % Bottom inner margin
    toptitle=4pt,                % Space above title
    bottomtitle=2pt,             % Space below title
}{def}
\newtcbtheorem[number within=section]{theorem}{Theorem}%
{
    coltitle=violet!90!black,
    colback=violet!10!white,       % Light green background
    colbacktitle=violet!10!white,  % Same background for title
    colframe=violet!90!black,     % Dark green left border
    fonttitle=\bfseries,
    fontupper={\linespread{1.2}\selectfont},
    boxrule=0pt,
    leftrule=4pt,
...
{
    coltitle=magenta!90!black,
    colback=magenta!10!white,       % Light green background
    colbacktitle=magenta!10!white,  % Same background for title
    colframe=magenta!90!black,     % Dark green left border
    fonttitle=\bfseries,
    fontupper={\linespread{1.2}\selectfont},
    boxrule=0pt,
    leftrule=4pt,
...
\newtcolorbox{remark}{
    coltitle=black,
    colback=white,               % Plain white background
    colbacktitle=white,
    colframe=gray!50!black,      % Gray frame
    title={\Sagittarius\bfseries Remark},    % Static title "Remark"
    fonttitle=\bfseries,
    fontupper={\linespread{1.2}\selectfont},
    boxrule=0pt,
    leftrule=4pt,
...
\begin{document}
    ...
    \begin{definition}{Coordinate Charts}{coordinate-charts}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{definition}{Overlap Function}{overlap-function}
    ...
    \begin{definition}{Atlas}{atlas}
        ...
        \end{enumerate}
    \end{definition}
    \begin{definition}{Differentiable Manifolds}{differentiable-manifolds}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{definition}{Coordinate Functions}{coordinate-functions}
    ...
    \begin{definition}{Curve}{curve}
        A curve on \(\manifold[M]\) is a \(C^\infty\) map,
        \[
        \sigma : (-\epsilon, \epsilon) \to \manifold[M].
        \]
    \end{definition}
    \begin{definition}{Curve Tangency}{curve-tangency}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{definition}{Tangent Vectors}{tangent-vector-curve}
        ...
        \]
    \end{definition}
    \begin{definition}{Tangent Space}{tangent-space-curve}
        The tangent space \(T_p\manifold[M]\) at point \(p\) is the set of all 
        tangent vectors at point \(p\).
    \end{definition}
    \begin{definition}{Tangent Bundle}{tangent-bundle-curve}
    ...
    \begin{definition}{Addition and Scalar Multiplication}{addition-and-scalar-multiplication-curve}
    ...
    \begin{definition}{Directional Derivative}{directional-derivative-curve}
    ...
    \end{definition}
    \begin{definition}{Tangent Space (Algebraic)}{tangent-space-algebraic}
        The space of all derivations at \(p \in \manifold[M]\) is denoted 
        \(D_p\manifold[M]\).
    \end{definition}
    \begin{definition}{Addition and Scalar Multiplication}{addition-scalar-multiplication-algebraic}
    ...
    \begin{definition}{Basis Tangent Vectors}{basis-derivations}
    ...
    \begin{proof}
        ...
        \]
    \end{proof}
    \begin{theorem}{Linear Independence of Basis Tangent Vectors}{linear-indep-basis}
    ...
    \begin{proof}
        ...
        So \(a^\mu=0\).
    \end{proof}
    \begin{theorem}{Coordinate Expansion of Tangent Vectors}{tangent-vector-coordinates}
    ...
    \begin{theorem}{Isomorphism of Curves and Derivations}{curve-derivation-iso}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{definition}{Pushforward}{pushforward}
    ...
    \end{theorem}
    \begin{theorem}{Algebraic Definition of Pushforward}{algebraic-pushforward}
    ...
    \end{proof}
    \begin{theorem}{Linearity of Pushforward}{linearity-of-pushforward}
    ...
    \begin{theorem}{Local Representative of Pushforward}{pushforward-local}
    ...
    \begin{proof}
        ...
        \]
    \end{proof}
    \begin{theorem}{Using Curve to Pushforward}{curve-pushforward}
    ...
    \begin{proof}
        ...
        \]
    \end{proof}
    \begin{theorem}{Contravariancy of Tangent Vectors}{contravariant-vector}
    ...
    \begin{definition}{Lie Derivative}{lie-derivative}
        ...
        \]
    \end{definition}
    \begin{theorem}{Properties of Lie Derivative}{lie-derivative-properties}
        ...
        \end{enumerate}
    \end{theorem}
    \begin{theorem}{Component of Vector Field}{vector-field-component}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{theorem}{Contravariancy of Vector Fields}{}
    ...
    \begin{definition}{Composition of Vector Fields}{vector-field-composition}
        ...
        \]
    \end{definition}
    \begin{definition}{Lie Bracket (Commutator)}{lie-bracket}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{theorem}{Lie Bracket Components}{lie-bracket-components}
        \[
        [X, Y]^\mu = (X^\nu\tfld{\nu}Y^\mu - Y^\nu\tfld{\nu}X^\mu).
        \]
    \end{theorem}
    \begin{proof}
        ...
        \]
    \end{proof}
    \begin{theorem}{Properties of Lie Brackets}{lie-bracket-properties}
        \begin{enumerate}
    ...
    \begin{definition}{Intergral Curve}{intergral-curve}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{definition}{Differential Equations of Integral Curve}{de-int-curve}
    ...
    \begin{definition}{Local 1D Family of Local Diffeomorphisms}{local-diff}
    ...
    \begin{remark}
        ...
        \hfill\Virgo
    \end{remark}
    \begin{definition}{Induced Vector Field}{induced-vector-field}
    ...
    \begin{definition}{Local Flow}{local-flow}
    ...
    \begin{theorem}{Interpretation of Lie Bracket}{lie-bracket-flow}
    ...
    \begin{definition}{Cotangent Spaces}{cotangent-space}
    ...
    \end{definition}
    \begin{definition}{One-Form}{one-form}
    ...
    \end{definition}
    \begin{definition}{Basis Cotangent Vectors}{cotangent-basis}
        ...
        \]
    \end{definition}
    \begin{theorem}{Coordinate Expression of Cotangent Vectors}{cotangent-coordinates}
