...
\begin{document}
    ...
    \begin{proof}
        ...
        of the \(0\)'s, which contradicts Invariance of Domain. 
    \end{proof}
    \begin{remark}
    ...
    \begin{remark}
        ...
        definition only asks for existence, but it does not guarantee that two coordinate charts will always agree on whether their first component is zero.
    ...
    \begin{theorem}[Equation and Submanifolds]\label{thm:equation-submanifold-no-boundary}
        ...
        submanifold of \(\manifold[M]\) of codimension \(r\).
    \end{theorem}
    \subsubsection{Dimension of Submanifolds of General Linear Group}
    \begin{theorem}[Dimension of Special Linear Group \(\SPLI{n}{\reals}\)]\label{thm:dim-slnr}
        \(\SPLI{n}{\reals}\) is a submanifold of \(\GL{n}{\reals}\) codimension \(1\); 
        \(\dim \SPLI{n}{\reals} = n^2-1\).
    \end{theorem}
    \begin{proof}
        Consider \(f = \det : \manifold[M]=\GL{n}{\reals} \to \mathbb{R}\). We want to 
        ...
        group property of \(\SPLI{n}{\reals}\).
        %\begin{center}
        %    \input{./figs/slnrLie.tex}
        %\end{center}
        \par
        So we know
        \[
    ...
    \end{proof}
    \begin{theorem}[Dimension of Orthogonal Group \(\ORTH{n}{\reals}\)]\label{thm:dim-onr}
        The orthogonal group \(\ORTH{n}{\reals}=\Set{A \in M_n(\mathbb{R})}{AA ^{\top}
        =I_n}\) is a \(C^\infty\) submanifold of \(\GL{n}{\reals}\) of codimension 
        \(\frac{n(n+1)}{2}\), and thus \(\dim \ORTH{n}{\reals}=\frac{n(n-1)}{2}\).
    \end{theorem}
%    \begin{proof}
%        Consider the following diagram,
%        \begin{center}
%            \input{./figs/onrLie.tex}
%        \end{center}
