...
\begin{document}
    ...
    \begin{definition}[Exterior Product]\label{def:formal-exterior-product}
        Let \(\omega = \omega_{i_1\dots i_k} dx^{i_1} \wedge \dots \wedge dx^{i_k}\), 
    ...
    \begin{remark}
        ...
        \begin{enumerate}
            \item Consider a 0-form, i.e. \(f \in C^\infty\). Then 
            \[
            df = \frac{\partial f}{\partial x}dx+\frac{\partial f}{\partial y}dy 
            + \frac{\partial f}{\partial z}dz \rightarrow \nabla f.
            \]
            \item Consider a 1-form \(\omega = Pdx+Qdy+Rdz\). Then 
            \[
            \begin{aligned}
            ...
            \end{aligned}
            \]
            \item Consider a 2-form \(\eta = A dy\wedge dz + B dz \wedge dx + 
            C dx \wedge dy\). Then 
            \[
            \begin{aligned}
            ...
            \end{aligned}
            \]
            \item The Hodge star operator does exactly this correspondance.
        \end{enumerate}
    \end{remark}
    \newpage
